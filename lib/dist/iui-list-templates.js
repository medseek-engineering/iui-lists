...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/$iui-lists/icons/symbol-defs.html',
    ...
    '        <path fill-opacity="0" d="M0,0.75 L24,0.75 L24,24.75 L0,24.75 L0,0.75 Z"></path>\n' +
    '    </g>\n' +
    '  </symbol>\n' +
    '</svg>');
}]);
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/$iui-lists/iui-list/iui-link-list.html',
    '<iui-list>\n' +
    '  <iui-list-item ng-repeat="linkItem in listData track by linkItem[linkIndexProperty]">\n' +
